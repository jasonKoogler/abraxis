...
func (s *TenantDomainService) AddDomain(ctx context.Context, params *AddDomainParams, actorID uuid.UUID, actorType string) (*TenantDomain, error) {
	...
	s.auditService.LogEvent(ctx, &domain.AuditLogReq{
		EventType:    "tenant.domain.added",
		ActorType:    actorType,
		ActorID:      actorID.String(),
		TenantID:     domain.FormatTenantID(params.TenantID),
		ResourceType: "tenant",
		ResourceID:   domain.FormatTenantID(params.TenantID),
		EventData:    eventData,
	})
...
func (s *TenantDomainService) VerifyDomain(ctx context.Context, params *VerifyDomainParams, actorID uuid.UUID, actorType string) error {
	...
	s.auditService.LogEvent(ctx, &domain.AuditLogReq{
		EventType:    "tenant.domain.verified",
		ActorType:    actorType,
		ActorID:      actorID.String(),
		TenantID:     domain.FormatTenantID(params.TenantID),
		ResourceType: "tenant",
...
func (s *TenantDomainService) RemoveDomain(ctx context.Context, tenantID uuid.UUID, actorID uuid.UUID, actorType string) error {
	...
	s.auditService.LogEvent(ctx, &domain.AuditLogReq{
		EventType:    "tenant.domain.removed",
		ActorType:    actorType,
		ActorID:      actorID.String(),
		TenantID:     domain.FormatTenantID(tenantID),
		ResourceType: "tenant",
		ResourceID:   domain.FormatTenantID(tenantID),
		EventData:    eventData,
	})
